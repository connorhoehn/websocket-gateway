# Requirements Archive: v1.4 UI Polish & Feature Completeness
...
- [x] **PRES-01**: Typing indicator is visibly displayed in the chat panel (e.g. "Alice is typing…")
- [x] **PRES-02**: Typing indicator is also reflected in the presence/user list panel
